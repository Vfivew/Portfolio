...
const useFormValidation = () => {
  ...
  const [phoneNumberError, setPhoneNumberError] = useState('Формат номеру телефону "0999999999"');
  const [selectedServiceError, setSelectedServiceError] = useState('Оберіть послугу');
  const [commentsError, setCommentsError] = useState('Будь ласка, не більше 200 символів');
  ...
  }, [name, phoneNumber, selectedService, comments, isNameDirty,
     isPhoneNumberDirty, isServiceDirty, isCommentsDirty]);
